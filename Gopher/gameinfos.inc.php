...
'presentation' => array(
    totranslate("Gopher is a very simple game that I designed specifically for Board Game Arena.  Gopher rules: Place a 
    checker next to one enemy checker and no friendly checkers.  Last player to place a checker wins."),   
    totranslate("Thanks to the BGA developer community for assisting me with this program, especially Sunil Patel."),
    totranslate("The checkers in Gopher are photos of backgammon checkers manufactured by Crisloid, in Rhode Island,
    USA.  Jeff Caruso, owner of Crisloid, has granted permission for their use in Gopher at Board Game Arena.")
),
