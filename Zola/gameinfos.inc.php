...
'presentation' => array(
    totranslate("Zola rules: You can make a non-capturing, king like move away from the center of the board, line of sight 
    ...
    totranslate("Thanks to Tisaac, VictoriaLa, robinzig, and hersh for helping me with errors... and to ufm for helping me with 
                the player panels.  Jurica fixed the program to accommodate games started before game options were added."),
    totranslate("Photos.  Zola is a simple game.  The SEE THE GAME IN ACTION feature imparts a clear and complete understanding of 
                ...
                Mongolia."),
                totranslate("Zola. A puppy that was living at my construction site. Me and my friendly cow. Some countryside scenes.  
                Design.")
//    ...
),
