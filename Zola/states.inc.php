...
$machinestates = array(
    ...
    3 => array(
        ...
        //"transitions" => array( "unselectChecker" => 2, "selectDestination" => 4, "zombiePass" => 4 )
    ),
    ...
    13 => array(
		...
		//"descriptionmyturn" => clienttranslate('Do ${you} want to take your oponent first move and switch colors (or play with your current color)?'),
