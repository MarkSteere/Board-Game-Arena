 ...
 *        with the same ID (see "initGameStateLabels" in zola.game.php)
 *
...
$game_options = array(
        101 => array(
                ...
                'values' => array(
                            ...
                            // 6x6
                            6 => array( 'name' => totranslate('Standard: 6x6'), 'size' => 6, 'tmdisplay' => totranslate('Standard: 6x6') ),
                            
                            // Optimal one according to Nash
                            8 => array( 'name' => totranslate('Big board: 8x8'), 'size' => 8, 'tmdisplay' => totranslate('Big board: 8x8') )
                        )
            )
);
