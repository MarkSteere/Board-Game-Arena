 ...
 * fractal.action.php
 *
 * Fractal main action entry point
 *
 *
 ...
 * this.ajaxcall( "/fractal/fractal/myAction.html", ...)
 *
 */
  
  
  class action_fractal extends APP_GameAction
  { 
    ...
    public function placeTile()
    {
        ...
        $result = $this->game->placeTile( $u, $v );
        self::ajaxResponse( );
    }
