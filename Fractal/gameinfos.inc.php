...
'presentation' => array(
    totranslate("Fractal is a variant of Hex.  As in Hex, you must connect opposite sides of the board of your color with a 
    ...
    totranslate("The tiles were constructed mostly from photos of the Mongolian countryside, but also include water, mud, rocks, 
