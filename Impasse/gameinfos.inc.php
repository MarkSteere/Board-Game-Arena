...
'player_colors' => array( "ff0000", "ffff00" ),
...
'presentation' => array(
    totranslate("Impasse is played with a Checkers set - either an 8x8 board with 12 checkers of each color, or a 10x10 
                 board with 20 checkers of each color.  Only the dark squares are used.  The object is to remove all of 
                 your checkers from the board."),
    totranslate("Please see the rule sheet and the tutorial."),
    totranslate("The backdrop is a photo of Lake Khuvsgul in Mongolia.  At 2 million years, its one of the oldest lakes in 
                 the world.  Its clear, pure water is safe to drink untreated.")
//    ...
),
...
'tags' => array( 3, 11, 28, 29, 30, 1, 209 ),
