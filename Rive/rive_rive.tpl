...
var jstpl_player_board = '<div style="font-size:4px;">&nbsp;</div><div class="cp_board"><div class="icon_placed_checkers_${code_img}" id="icon-placed-checkers_${player_id}"></div><span id="placed-checkers_p${player_id}">0</span></div>';
