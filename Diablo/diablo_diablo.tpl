...
var jstpl_black_checker='<div class="black_checker_{BOARD_SIZE}" id="${checker_id}" style="${bkgPos}; pointer-events: none; z-index: 3"></div>';
...
var jstpl_last_move_indicator='<div class="last_move_indicator" id="${last_move_indicator_id}" style="${bkgPos}; pointer-events: none; z-index: 5"></div>';
