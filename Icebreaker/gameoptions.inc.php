 ...
 * gameoptions.inc.php
 *
 * Icebreaker game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in icebreaker.game.php)
 *
 ...
 $game_options = array(
        101 => array(
                ...
                'values' => array(
                            ...
                            // Size 5
                            5 => array( 'name' => totranslate('Size 5'), 'size' => 5, 'tmdisplay' => totranslate('Size 5') ),
