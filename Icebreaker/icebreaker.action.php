 ...
 * -----
 * 
 * icebreaker.action.php
 *
 * Icebreaker main action entry point
 *
 *
 ...
 * this.ajaxcall( "/icebreaker/icebreaker/myAction.html", ...)
 *
 */
  
  
  class action_icebreaker extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "icebreaker_icebreaker";
